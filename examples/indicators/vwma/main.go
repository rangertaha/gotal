...
func main() {
	...
	volume := []float64{1000, 1200, 900, 1500, 1100, 1300, 1400, 1600, 1700, 1800, 1900, 2000, 2100, 2200, 2300, 2400, 2500, 2600, 2700, 2800}
	...
	out, err := gotal.Get("VWMA")(ts, gotal.With("period", 5))
	if err != nil {
		log.Fatal(err)
	}
	out.Print()
